...
from base.base_miner import BaseMiner, MinerConfig
from base.base_module import ModuleConfig
from .data_models import TranslationRequest, TranslationData, TARGET_LANGUAGES, TASK_STRINGS
...
class TranslationMiner(BaseMiner):
    ...
    def process(self, request: TranslationRequest):
        ...
        if request.data["task_string"].endswith("2speech"):
            return {"output": base64.b64encode(output_audio).decode("utf-8")}
