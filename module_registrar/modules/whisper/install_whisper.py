...
def convert_to_wav(file_path):
    ...
    output_path = Path(f"module_registrar/modules/whisper/out/{output_name}")
    subprocess.run(
        [
            "ffmpeg",
            "-i",
...
inference_types = Path("module_registrar/modules/inference_types.json")
...
file_paths = {
    "install_whisper_sh": Path(
        "module_registrar/modules/whisper/install_whisper.sh"
    ),
    "example_sh": Path("module_registrar/modules/whisper/example.sh"),
    "convert_file_py": Path("module_registrar/modules/whisper/convert_file.py"),
    "whisper_py": Path("module_registrar/modules/whisper/whisper.py"),
}
data = {
...
subprocess.run(
    ["bash", "module_registrar/modules/whisper/install_whisper.sh"], check=True
)
